...
VALUES
    ('2000-01-15',
     ...
     'Joe',
     'Fontes',
     '$2a$10$zGp1XxUHnH9fsKMJlw8YLe5RGUxqjgMXcW4VYHZxvahgJgRNKVavm',
     'ROLE_COORDINATOR', 1), ('2000-01-15',
                              'binto@example.com',
                              'Joe',
                              'Fontes',
                              '$2a$10$zGp1XxUHnH9fsKMJlw8YLe5RGUxqjgMXcW4VYHZxvahgJgRNKVavm',
                              'ROLE_COORDINATOR', null);

   INSERT INTO `course` (`description`, `name`, `coordinator_id`) VALUES ('Course description 1','Computer Science',1);
--

   INSERT INTO `course_disciplines` (`course_id`, `disciplines_id`) VALUES (1, 1);
--
-- INSERT INTO `student` (`birth_date`, `email`, `first_name`, `last_name`, `password`, `role`, `address`) VALUES ('2000-05-15','john@email.com','John','Reis','$2a$10$0X8RBwIqdBWLIJ/jSjF4puDAZuqOVSK2QDOIXNeU8.XoS4fehIRTy','ROLE_STUDENT','Santa Catarina/SC | Palhoça, Passa Vinte, Rua João Cândido da Rosa');
--
